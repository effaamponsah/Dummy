      ...
      <View>
        ...
        >
          ...
          >
            ...
            <Text>
              Payment Address {invoice.payment_firstname}{" "}
              {invoice.payment_lastname} {invoice.payment_address_1}{" "}
              {invoice.payment_city}
            </Text>
            <Text>Payment Method : {invoice.payment_method}</Text>
            <Text>
              Shipping Address : {invoice.shipping_firstname}{" "}
              {invoice.shipping_lastname} {invoice.shipping_address_1}{" "}
